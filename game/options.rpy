...
define config.name = _("Reflect_The_Spirit_Within")
...
define build.name = "Reflect_The_Spirit_Within"
...
define config.save_directory = "Reflect_The_Spirit_Within-1753713450"
